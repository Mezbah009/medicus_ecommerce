            ...
            <div class="col-md-3 sidebar">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php
                        // $isChecked = (in_array($brand->id, $brandsArray)) ? 'checked' : '';
                        ?>
                    ...
                    <div class="col-md-4">
                        <div class="card product-card">
                            <div class="product-image position-relative">
                                ...
                                @else
                                    <img class="card-img-top" src="{{ asset('admin-assets/img/burger.jpg')}}" height="150px" width="150px"/>
                                @endif
                                </a>
                                @if($product->product_items != null && $product->product_items->isNotEmpty())
                                    @php
