...
<section class="content">
    <!-- Default box -->
    <form action="" method="POST" id="weightsForm" name="weightsForm">
        {{-- @csrf --}}
    ...
    <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="double" name="min_weight" id="min_weight" class="form-control" placeholder="Min weight">
                            <p class="error"></p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="double" name="max_weight" id="max_weight" class="form-control" placeholder="Max weight">
                            <p class="error"></p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="double" name="price" id="price" class="form-control" placeholder="Price">
                            <p class="error"></p>
                        </div>
                    </div>
        ...
        <div class="pb-5 pt-3">
            ...
            <a href="{{route('weights.create')}}" class="btn btn-outline-dark ml-3">Cancel</a>
        </div>
    </div>
</form>
