        ...
        <div class="container-fluid my-2">
            <div class="row mb-2">
                ...
                <div class="col-sm-6 text-right">
                    <a href="{{route('sliders.create')}}" class="btn btn-primary">New Slider</a>
                </div>
            </div>
        </div>
        <!-- /.container-fluid -->
                ...
                <form action="" method="GET">
                    <div class="card-header">
                        <div class="card-title">
                            <button type="button" onclick ="window.location.href='{{route("sliders.index")}}'" class="btn btn-default btn-sm">reset</button>
                        </div>
...
{{--                                @php--}}
{{--                                    $sliderImage = $slider->product_images->first();--}}
                                ...
                                <tr>
                                    ...
                                    <td>{{$slider->title}}</td><td>
                                        @if(!empty($slider->image))
                                            <img src="{{asset('uploads/slider/'.$slider->image)}}" class="img-thumbnail" alt="{{$slider->title}}" width="50">
                                        @else
                                    ...
                                    <td>
                                        ...
                                        <a href="#" onclick="destroySlider({{$slider->id}})" class="text-danger w-4 h-4 mr-1">
...
@section('customJs')
    <script>
        function destroySlider(id){
            var url = '{{ route("sliders.delete", "ID") }}';
