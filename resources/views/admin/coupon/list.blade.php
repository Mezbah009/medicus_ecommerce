                            ...
                            @foreach ($discountCoupons as $discountCoupon)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        {{ \Carbon\Carbon::parse($discountCoupon->starts_at)->format('Y/m/d H:i:s') }}
                                        @else
                                        {{$discountCoupon->starts_at}} 
                                        @endif
                                    </td>
                                    <td>
                                        @if (empty($discountCoupon->expires_at))
                                        {{ \Carbon\Carbon::parse($discountCoupon->expires_at)->format('Y/m/d H:i:s') }}
                                        @else
                                    ...
                                    <td>
                                        ...
                                        <a href="#" onclick="destroyCoupon({{$discountCoupon->id}})" class="text-danger w-4 h-4 mr-1">
