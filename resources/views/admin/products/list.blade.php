                            ...
                            @foreach ($products as $product)
                                ...
                                <tr>
                                    ...
                                    @if(!empty($productImage->image))
                                        <img src="{{asset('uploads/product/small/'.$productImage->image)}}" class="img-thumbnail" alt="{{$product->title}}" width="50">
                                    @else
                                    ...
                                    <td>
                                        ...
                                        <a href="#" onclick="destroyProduct({{ $product->id }})" class="text-danger w-4 h-4 mr-1">
    ...
    <script>
        function destroyProduct(id) {
            ...
            if (confirm("Are you sure you want to delete?")) {
                $.ajax({
                    url: url,
                    type: 'DELETE', // Use 'DELETE' for the request method
                    data: {}, // You can include data to send to the server if needed
                    dataType: 'json',
