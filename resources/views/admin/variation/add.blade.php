...
<section class="content-header">
    <div class="container-fluid my-2">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Add Product Variation Options</h1>
            </div>
...
<section class="content">
    <div class="container-fluid">
        <form action="{{ route('variation.save') }}" method="post" id="VariationDetailForm" name="VariationDetailForm">
            @csrf
            <div class="card">
                <div class="card-body">
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-12 form-group">
                                <label for="name" class="col-md-12 col-form-label">Add New Information</label>
                                <div class="row">
            ...
            <div class="pb-5 pt-3">
                ...
                <a href="{{ route('variation.add',$id) }}" class="btn btn-outline-dark ml-3">Cancel</a>
            </div>
        </form>
    </div>
</section>
...
<script>
    $(document).ready(function () {
        ...
        $('#VariationDetailForm').on('submit', function (e) {
            e.preventDefault();
