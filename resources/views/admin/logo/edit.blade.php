...
@section('content')
        ...
        <div class="container-fluid my-2">
            <div class="row mb-2">
                ...
                <div class="col-sm-6 text-right">
                    <a href="{{route('logo.index')}}" class="btn btn-primary">Back</a>
                </div>
            </div>
        </div>
        <!-- /.container-fluid -->
    ...
    <section class="content">
        <!-- Default box -->
        <form action="" method="POST" id="logoForm" name="logoForm">
            {{-- @csrf --}}
            ...
            <div class="container-fluid">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                @if(!empty($logoId->image))
                                <div>
                                    <img width="200" src="{{ asset('uploads/logo/'.$logoId->image) }}" alt="">
                                </div>
                                @endif
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <textarea name="description" id="description" cols="30" rows="10" class="form-control" placeholder="Description">{{$logoId->description}}</textarea>
                ...
                <div class="pb-5 pt-3">
                    ...
                    <a href="{{route('logo.create')}}" class="btn btn-outline-dark ml-3">Cancel</a>
                </div>
            </div>
        </form>
...
@section('customJs')
    ...
    <script>
        $("#logoForm").submit(function(event){
            ...
            $.ajax({
                url: '{{ route("logo.update",$logoId->id) }}',
                type: 'PUT',
